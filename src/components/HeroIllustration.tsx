...
// 1. Register the GSAP Plugin
gsap.registerPlugin(DrawSVGPlugin);

// 2. The color constant you requested.
// The hex #70124124 is likely a typo. A common purple in the SVG is #706AED.
// We define it here for demonstration. While not used to change colors in this
// animation, you could use it in your GSAP tweens like: gsap.to(el, { fill: THEME_COLOR });
const THEME_COLOR = '#706AED';


/**
 * Encapsulates the GSAP animation logic for the SVG.
 * @param container The root SVG element to animate.
 */
const runIllustrationAnimation = (container: HTMLElement) => {
  if (!container) return;

  // --- 3. Select elements for animation using IDs and CSS selectors ---
  const allGraphs = gsap.utils.toArray("#graph_x5F_1, #graph_x5F_2, #graph_x5F_3, #graph_x5F_4, #graph_x5F_5, #diagram");
  const guy = gsap.utils.toArray("#guy_x5F_head, #guy_x5F_body, #guy_x5F_left_hand, #guy_x5F_right_hand, #guy_x5F_left_leg, #guy_x5F_right_leg, #guy_x5F_tablet");
  const girl = gsap.utils.toArray("#girl_x5F_head, #girl_x5F_hairs, #girl_x5F_body, #girl_x5F_left_hand, #girl_x5F_right_hand, #girl_x5F_left_leg, #girl_x5F_right_leg, #girl_x5F_tablet, #girl_x5F_skirt");
  const joints = gsap.utils.toArray("#joints_x5F_1 path, #joints_x5F_2 path, #joints_x5F_3 path, #joints_x5F_4 path");
  
  // Bar chart bars
  const barChartBars = container.querySelectorAll("#graph_x5F_4 g > g > path:first-child");
  // Checkbox checkmarks
  const checkmarks = container.querySelectorAll("#graph_x5F_5 g > g > path");


  // --- 4. Set initial states (invisible, off-screen, etc.) ---
  gsap.set([allGraphs, guy, girl, joints], { autoAlpha: 0 });
  gsap.set(allGraphs, { scale: 0, transformOrigin: "center center" });
  gsap.set(guy, { y: '+=120' });
  gsap.set(girl, { y: '+=120' });

  // --- 5. Create the master timeline for the entrance animation ---
  ...
  tl
    ...
    .to("#background", { autoAlpha: 1, duration: 1.5, ease: 'sine.inOut' }, 0)
    .to(guy, { autoAlpha: 1, y: 0, stagger: 0.05, ease: 'back.out(1.7)' }, 0.5)
    .to(girl, { autoAlpha: 1, y: 0, stagger: 0.05, ease: 'back.out(1.7)' }, 0.7)
    ...
    // --- 6. Animate specific graph details on a parallel timeline ---
    const detailsTl = gsap.timeline({delay: 2.2});

    detailsTl
      // Bar Chart (#graph_x5F_4)
      .from(barChartBars, {
          scaleY: 0,
      ...
      // Line Graph (#graph_x5F_1)
      .from("#graph_x5F_1 path[fill='#1AA9E8']", {
          drawSVG: "0%",
          duration: 1
      }, "<")

      // Pie Chart (#diagram) - Animate from the center point
      .from("#diagram path[fill^='url']", {
          scale: 0.5,
          autoAlpha: 0,
          transformOrigin: '379px 248.5px', // Calculated center of the pie
          stagger: 0.2,
          ease: 'back.out(1.7)'
      }, "<")
      
      // Wavy line graph (#graph_x5F_3) - draw from the middle out
      .from("#graph_x5F_3 path[fill='url(#SVGID_30_)']", {
          drawSVG: "0% 50%", 
          duration: 1.2,
          ease: 'power2.out'
      }, "<");

  // --- 7. Create continuous, looping idle animations ---
  // Characters bobbing
  gsap.to([guy, girl], {
      y: '-=5',
      repeat: -1,
...
const AnimatedIllustration: Component = () => {
  let svgContainer: HTMLDivElement | undefined;

  onMount(() => {
    // Run the animation function after the component has mounted
    runIllustrationAnimation(svgContainer!);
  });

  return (
    <div ref={svgContainer} class='lg:scale-80 scale-50'>
      {/* The SVG provided in the prompt is placed directly here */}
	 ...
	 height="900px" viewBox="0 0 900 900" enable-background="new 0 0 900 900" xml:space="preserve">
        ...
        <g id="background">
          <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="201.7715" y1="153.2905" x2="667.9931" y2="619.5121">
          ...
          <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="626.5986" y1="791.9678" x2="626.5986" y2="746.8525">
          ...
          <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="261.4277" y1="816.5088" x2="261.4277" y2="775.0801">
            <stop  offset="0" style="stop-color:#F7EBFF"/>
            <stop  offset="1" style="stop-color:#DBEFFF"/>
          </linearGradient>
        ...
        <g id="graph_x5F_5">
          <g>
            <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="388.3457" y1="497.9609" x2="412.2396" y2="521.8548">
          ...
          <g>
            <linearGradient id="SVGID_5_" gradientUnits="userSpaceOnUse" x1="388.3447" y1="534.8193" x2="412.24" y2="558.7146">
              <stop  offset="0" style="stop-color:#FF57BD"/>
              <stop  offset="1" style="stop-color:#FE6A77"/>
            </linearGradient>
          ...
          <g>
            <linearGradient id="SVGID_6_" gradientUnits="userSpaceOnUse" x1="388.3457" y1="571.6797" x2="412.2396" y2="595.5735">
              <stop  offset="0" style="stop-color:#FF57BD"/>
              <stop  offset="1" style="stop-color:#FE6A77"/>
            </linearGradient>
        ...
        <g id="graph_x5F_4">
          <linearGradient id="SVGID_7_" gradientUnits="userSpaceOnUse" x1="351.6572" y1="355.0332" x2="485.2196" y2="488.5956">
          ...
          <g>
            <linearGradient id="SVGID_8_" gradientUnits="userSpaceOnUse" x1="362.188" y1="372.0845" x2="415.1055" y2="372.0845">
          ...
          <g>
            <g>
              <linearGradient id="SVGID_9_" gradientUnits="userSpaceOnUse" x1="466.6875" y1="471.001" x2="466.6875" y2="374.0015">
              ...
              <linearGradient id="SVGID_10_" gradientUnits="userSpaceOnUse" x1="458.6875" y1="393.0845" x2="474.6875" y2="393.0845">
            ...
            <g>
              <linearGradient id="SVGID_11_" gradientUnits="userSpaceOnUse" x1="418.438" y1="471.001" x2="418.438" y2="395.2515">
            ...
            <g>
              <linearGradient id="SVGID_13_" gradientUnits="userSpaceOnUse" x1="442.563" y1="471.001" x2="442.563" y2="409.2515">
                <stop  offset="0" style="stop-color:#FF57BD"/>
                <stop  offset="1" style="stop-color:#FE6A77"/>
              </linearGradient>
            ...
            <g>
              <linearGradient id="SVGID_15_" gradientUnits="userSpaceOnUse" x1="394.313" y1="471.001" x2="394.313" y2="381.7515">
              ...
              <linearGradient id="SVGID_16_" gradientUnits="userSpaceOnUse" x1="386.313" y1="398.2095" x2="402.313" y2="398.2095">
                <stop  offset="0" style="stop-color:#00E2EC"/>
                <stop  offset="1" style="stop-color:#0090B2"/>
              </linearGradient>
            ...
            <g>
              <linearGradient id="SVGID_17_" gradientUnits="userSpaceOnUse" x1="370.188" y1="471.001" x2="370.188" y2="425.7515">
                <stop  offset="0" style="stop-color:#FDE1A7"/>
                <stop  offset="1" style="stop-color:#F9A144"/>
              </linearGradient>
        ...
        <g id="graph_x5F_1">
          <g>
            <linearGradient id="SVGID_19_" gradientUnits="userSpaceOnUse" x1="172.876" y1="155.6265" x2="285.8756" y2="268.6261">
              <stop  offset="0" style="stop-color:#00E2EC"/>
              <stop  offset="1" style="stop-color:#0090B2"/>
            </linearGradient>
            ...
            <g>
              <linearGradient id="SVGID_20_" gradientUnits="userSpaceOnUse" x1="235.7505" y1="183.501" x2="290.0005" y2="183.501">
                <stop  offset="0" style="stop-color:#FFFFFF"/>
                <stop  offset="1" style="stop-color:#F1D1F8"/>
              </linearGradient>
        ...
        <g id="diagram">
          ...
          <g>
            <linearGradient id="SVGID_21_" gradientUnits="userSpaceOnUse" x1="281.6665" y1="239.0088" x2="335.001" y2="239.0088">
              <stop  offset="0" style="stop-color:#FDE1A7"/>
              <stop  offset="1" style="stop-color:#F9A144"/>
            </linearGradient>
            ...
            <linearGradient id="SVGID_22_" gradientUnits="userSpaceOnUse" x1="322.498" y1="178.3867" x2="454.0918" y2="178.3867">
            ...
            <linearGradient id="SVGID_23_" gradientUnits="userSpaceOnUse" x1="303.895" y1="269.8008" x2="476.334" y2="269.8008">
              <stop  offset="0" style="stop-color:#FF57BD"/>
              <stop  offset="1" style="stop-color:#FE6A77"/>
            </linearGradient>
          ...
          <linearGradient id="SVGID_24_" gradientUnits="userSpaceOnUse" x1="340.9312" y1="268.834" x2="410.1421" y2="268.834">
            <stop  offset="0" style="stop-color:#C7A0F6"/>
            <stop  offset="1" style="stop-color:#FF57BD"/>
          </linearGradient>
          ...
          <linearGradient id="SVGID_25_" gradientUnits="userSpaceOnUse" x1="379.0005" y1="242.5605" x2="419.667" y2="242.5605">
          ...
          <linearGradient id="SVGID_26_" gradientUnits="userSpaceOnUse" x1="350.2627" y1="219.7295" x2="379.0179" y2="248.4847">
            <stop  offset="0" style="stop-color:#1AA9E8"/>
            <stop  offset="0.4223" style="stop-color:#3D80EF"/>
            <stop  offset="0.7909" style="stop-color:#5662F4"/>
            <stop  offset="1" style="stop-color:#5F57F6"/>
        ...
        <g id="graph_x5F_3">
          <linearGradient id="SVGID_27_" gradientUnits="userSpaceOnUse" x1="517.4766" y1="106.5112" x2="694.8312" y2="283.8659">
          ...
          <g>
            ...
            <g>
              <linearGradient id="SVGID_28_" gradientUnits="userSpaceOnUse" x1="513.8184" y1="166.1675" x2="582.25" y2="166.1675">
                <stop  offset="0" style="stop-color:#FFFFFF"/>
                <stop  offset="1" style="stop-color:#F1D1F8"/>
              </linearGradient>
          ...
          <linearGradient id="SVGID_29_" gradientUnits="userSpaceOnUse" x1="611.9863" y1="239.8345" x2="611.9863" y2="148.3281">
            <stop  offset="0" style="stop-color:#994574"/>
          ...
          <linearGradient id="SVGID_30_" gradientUnits="userSpaceOnUse" x1="513.8184" y1="200.001" x2="698.4863" y2="200.001">
        ...
        <g id="graph_x5F_2">
          <linearGradient id="SVGID_31_" gradientUnits="userSpaceOnUse" x1="378.3286" y1="123.418" x2="466.6621" y2="123.418">
            <stop  offset="0" style="stop-color:#FDE1A7"/>
            <stop  offset="1" style="stop-color:#F9A144"/>
          </linearGradient>
        ...
        <g id="girl_x5F_tablet">
          <linearGradient id="SVGID_32_" gradientUnits="userSpaceOnUse" x1="525.0791" y1="393.8413" x2="602.6514" y2="393.8413">
            <stop  offset="0" style="stop-color:#00E2EC"/>
            <stop  offset="1" style="stop-color:#0090B2"/>
          </linearGradient>
          ...
          <linearGradient id="SVGID_33_" gradientUnits="userSpaceOnUse" x1="536.7393" y1="364.1782" x2="590.2432" y2="417.6822">
            <stop  offset="0" style="stop-color:#994574"/>
            <stop  offset="1" style="stop-color:#43256F"/>
          </linearGradient>
        ...
        <g id="girl_x5F_right_leg">
          <linearGradient id="SVGID_34_" gradientUnits="userSpaceOnUse" x1="598.7383" y1="685.0693" x2="638.9893" y2="685.0693">
          ...
          <linearGradient id="SVGID_35_" gradientUnits="userSpaceOnUse" x1="584.6963" y1="763.5596" x2="630.9092" y2="763.5596">
            <stop  offset="0" style="stop-color:#706AED"/>
            <stop  offset="1" style="stop-color:#271068"/>
          </linearGradient>
        ...
        <g id="girl_x5F_left_leg">
          <linearGradient id="SVGID_36_" gradientUnits="userSpaceOnUse" x1="656.75" y1="687.6621" x2="694.8574" y2="687.6621">
            <stop  offset="0" style="stop-color:#F4BEA3"/>
            <stop  offset="1" style="stop-color:#E8878E"/>
          </linearGradient>
          <path fill="url(#SVGID_36_)" d="M674.752,762.168c6.943-3.437,14.803-7.292,20.105-7.15c-0.217-3.445-0.471-6.68-0.607-8.85
            ...
            z"/>
          <linearGradient id="SVGID_37_" gradientUnits="userSpaceOnUse" x1="649" y1="764.3594" x2="695.2393" y2="764.3594">
            <stop  offset="0" style="stop-color:#706AED"/>
            <stop  offset="1" style="stop-color:#271068"/>
          </linearGradient>
        ...
        <g id="girl_x5F_skirt">
          <linearGradient id="SVGID_38_" gradientUnits="userSpaceOnUse" x1="600.0654" y1="519.6025" x2="701.5601" y2="621.0972">
            <stop  offset="0" style="stop-color:#FF57BD"/>
            <stop  offset="1" style="stop-color:#FE6A77"/>
          </linearGradient>
        ...
        <g id="girl_x5F_right_hand">
          <linearGradient id="SVGID_39_" gradientUnits="userSpaceOnUse" x1="580.4365" y1="390.9629" x2="591.6777" y2="390.9629">
            <stop  offset="0" style="stop-color:#C16846"/>
            <stop  offset="0.2653" style="stop-color:#D27565"/>
            <stop  offset="0.5308" style="stop-color:#DE7F7B"/>
            <stop  offset="0.7814" style="stop-color:#E58589"/>
            <stop  offset="1" style="stop-color:#E8878E"/>
          </linearGradient>
          ...
          <linearGradient id="SVGID_40_" gradientUnits="userSpaceOnUse" x1="607.4941" y1="428.1699" x2="645.4111" y2="428.1699">
            <stop  offset="0" style="stop-color:#FDE1A7"/>
            <stop  offset="1" style="stop-color:#F9A144"/>
          </linearGradient>
          ...
          <linearGradient id="SVGID_41_" gradientUnits="userSpaceOnUse" x1="572.5664" y1="398.5547" x2="621.5" y2="398.5547">
            <stop  offset="0" style="stop-color:#F4BEA3"/>
            <stop  offset="1" style="stop-color:#E8878E"/>
          </linearGradient>
        ...
        <g id="girl_x5F_body">
          <linearGradient id="SVGID_42_" gradientUnits="userSpaceOnUse" x1="618.334" y1="444.6953" x2="683.3662" y2="444.6953">
            <stop  offset="0" style="stop-color:#FDE1A7"/>
            <stop  offset="1" style="stop-color:#F9A144"/>
          </linearGradient>
        ...
        <g id="girl_x5F_hairs">
          <linearGradient id="SVGID_43_" gradientUnits="userSpaceOnUse" x1="679.1484" y1="344.7109" x2="738.9618" y2="404.5243">
            <stop  offset="0" style="stop-color:#5A55F8"/>
            <stop  offset="1" style="stop-color:#8C6AE2"/>
          </linearGradient>
        ...
        <g id="girl_x5F_head">
          <linearGradient id="SVGID_44_" gradientUnits="userSpaceOnUse" x1="645.334" y1="382.0449" x2="671.334" y2="382.0449">
            <stop  offset="0" style="stop-color:#F4BEA3"/>
            <stop  offset="1" style="stop-color:#E8878E"/>
          </linearGradient>
          <path fill="url(#SVGID_44_)" d="M668.834,368.834c-0.646,5.792,2.5,22.667,2.5,22.667s-7.834,8.125-19.334,8.667
            ...
            z"/>
          <linearGradient id="SVGID_45_" gradientUnits="userSpaceOnUse" x1="627.9004" y1="350.5342" x2="674.1445" y2="350.5342">
            <stop  offset="0" style="stop-color:#F4BEA3"/>
            <stop  offset="1" style="stop-color:#E8878E"/>
          </linearGradient>
          ...
          <linearGradient id="SVGID_46_" gradientUnits="userSpaceOnUse" x1="627.0645" y1="346.7734" x2="643.0283" y2="346.7734">
            <stop  offset="0" style="stop-color:#FF57BD"/>
          ...
          <linearGradient id="SVGID_47_" gradientUnits="userSpaceOnUse" x1="637.4238" y1="338.7939" x2="688.9844" y2="338.7939">
            <stop  offset="0" style="stop-color:#5A55F8"/>
            <stop  offset="1" style="stop-color:#8C6AE2"/>
          </linearGradient>
        ...
        <g id="girl_x5F_left_hand">
          <linearGradient id="SVGID_48_" gradientUnits="userSpaceOnUse" x1="537.9502" y1="426.9854" x2="574.6553" y2="426.9854">
            <stop  offset="0" style="stop-color:#F4BEA3"/>
            <stop  offset="1" style="stop-color:#E8878E"/>
          </linearGradient>
          ...
          <linearGradient id="SVGID_49_" gradientUnits="userSpaceOnUse" x1="564.6523" y1="441.3511" x2="676.459" y2="441.3511">
            <stop  offset="0" style="stop-color:#FDE1A7"/>
            <stop  offset="1" style="stop-color:#F9A144"/>
          </linearGradient>
        ...
        <g id="guy_x5F_tablet">
          <linearGradient id="SVGID_50_" gradientUnits="userSpaceOnUse" x1="284.6777" y1="581.21" x2="340.2927" y2="636.8249">
            <stop  offset="0" style="stop-color:#00E2EC"/>
            <stop  offset="1" style="stop-color:#0090B2"/>
          </linearGradient>
          ...
          <linearGradient id="SVGID_51_" gradientUnits="userSpaceOnUse" x1="282.7388" y1="579.2705" x2="342.2317" y2="638.7635">
            <stop  offset="0" style="stop-color:#706AED"/>
            <stop  offset="1" style="stop-color:#271068"/>
          </linearGradient>
        ...
        <g id="guy_x5F_left_leg">
          <linearGradient id="SVGID_52_" gradientUnits="userSpaceOnUse" x1="204.0952" y1="773.0967" x2="236.4826" y2="805.4841">
            <stop  offset="0" style="stop-color:#706AED"/>
            <stop  offset="1" style="stop-color:#271068"/>
          </linearGradient>
          ...
          <linearGradient id="SVGID_53_" gradientUnits="userSpaceOnUse" x1="147.5557" y1="569.4463" x2="290.5563" y2="712.4469">
            <stop  offset="0" style="stop-color:#994574"/>
            <stop  offset="1" style="stop-color:#43256F"/>
          </linearGradient>
        ...
        <g id="guy_x5F_right_leg">
          <linearGradient id="SVGID_54_" gradientUnits="userSpaceOnUse" x1="285.5854" y1="780.2607" x2="316.4792" y2="811.1545">
            <stop  offset="0" style="stop-color:#706AED"/>
            <stop  offset="1" style="stop-color:#271068"/>
          </linearGradient>
          ...
          <linearGradient id="SVGID_55_" gradientUnits="userSpaceOnUse" x1="187.2974" y1="559.1729" x2="359.0262" y2="730.9017">
            <stop  offset="0" style="stop-color:#994574"/>
            <stop  offset="1" style="stop-color:#43256F"/>
          </linearGradient>
        ...
        <g id="guy_x5F_left_hand">
          <linearGradient id="SVGID_56_" gradientUnits="userSpaceOnUse" x1="224.3857" y1="296.9795" x2="295.5815" y2="296.9795">
            <stop  offset="0" style="stop-color:#F4BEA3"/>
            <stop  offset="1" style="stop-color:#E8878E"/>
          </linearGradient>
        ...
        <g id="guy_x5F_body">
          <linearGradient id="SVGID_57_" gradientUnits="userSpaceOnUse" x1="181.2314" y1="387.4321" x2="301.026" y2="507.2267">
            <stop  offset="0" style="stop-color:#1AA9E8"/>
            <stop  offset="0.4223" style="stop-color:#3D80EF"/>
            <stop  offset="0.7909" style="stop-color:#5662F4"/>
            <stop  offset="1" style="stop-color:#5F57F6"/>
        ...
        <g id="guy_x5F_head">
          <g>
            <linearGradient id="SVGID_58_" gradientUnits="userSpaceOnUse" x1="268.7344" y1="344.5176" x2="281.4395" y2="344.5176">
            ...
            <linearGradient id="SVGID_59_" gradientUnits="userSpaceOnUse" x1="226.6084" y1="345.6523" x2="273.8119" y2="392.8559">
              <stop  offset="0" style="stop-color:#F4BEA3"/>
              <stop  offset="1" style="stop-color:#E8878E"/>
            </linearGradient>
            ...
            <linearGradient id="SVGID_60_" gradientUnits="userSpaceOnUse" x1="221.1572" y1="339.793" x2="271.605" y2="339.793">
            ...
            <linearGradient id="SVGID_61_" gradientUnits="userSpaceOnUse" x1="257.5176" y1="357.4326" x2="279.2148" y2="379.1299">
              <stop  offset="0" style="stop-color:#CB2090"/>
              <stop  offset="1" style="stop-color:#43256F"/>
            </linearGradient>
            ...
            <g>
              <linearGradient id="SVGID_62_" gradientUnits="userSpaceOnUse" x1="228.3608" y1="401.8101" x2="261.2661" y2="401.8101">
                <stop  offset="0" style="stop-color:#1AA9E8"/>
                <stop  offset="0.4223" style="stop-color:#3D80EF"/>
                <stop  offset="0.7909" style="stop-color:#5662F4"/>
                <stop  offset="1" style="stop-color:#5F57F6"/>
        ...
        <g id="guy_x5F_right_hand">
          <linearGradient id="SVGID_63_" gradientUnits="userSpaceOnUse" x1="268.5098" y1="532.832" x2="319.2881" y2="532.832">
            <stop  offset="0" style="stop-color:#F4BEA3"/>
            <stop  offset="1" style="stop-color:#E8878E"/>
          </linearGradient>
          ...
          <linearGradient id="SVGID_64_" gradientUnits="userSpaceOnUse" x1="260.1289" y1="447.7715" x2="300.0547" y2="447.7715">
            <stop  offset="0" style="stop-color:#1AA9E8"/>
            <stop  offset="0.4223" style="stop-color:#3D80EF"/>
            <stop  offset="0.7909" style="stop-color:#5662F4"/>
            <stop  offset="1" style="stop-color:#5F57F6"/>
